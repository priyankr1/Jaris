...
recognition.onresult = function (event) {
  ...
  if (localStorage.getItem("lang") === "en-US") {
    ...
    if (transcript.includes("tell about yourself ")) {
      var audio = document.getElementById("j_intro");
      audio.play();
    }
  ...
  if (localStorage.getItem("lang") === "hi-IN") {
    ...
    if (transcript.includes("इंग्लिश में बदलो")) {
      readOutHindi("इंग्लिश में बदल रह हूँ");
      speech_lang = "en-US";
      localStorage.setItem("lang", "en-US");
      stopingR = true;
      recognition.stop();
...
if (day != null) day.innerHTML = dayName;
if (dates != null) dates.innerHTML = dayNumber;
if (yearS != null) yearS.innerHTML = year;
...
async function getNews() {
  var url =
    "https://newsapi.org/v2/top-headlines?country=us&apiKey=dc1f7c8049e043dc8f0b8ee59a5b8e49";
...
async function getCategoryNews(category) {
  var url = `https://newsapi.org/v2/everything?q=${category}&&from=${yyyy}-${mm}-${dd}&&sortBy=popularity&apiKey=dc1f7c8049e043dc8f0b8ee59a5b8e49`;
